  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        '- Exact CSS property or code change',
      ...
      outputFormat: 'JSON with changes (array of {file, selector, property, currentValue, targetValue, estimatedImpact}), estimatedTotalImprovement, implementationOrder'
    },
    outputSchema: {
      type: 'object',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        '2. Locate the exact element/selector',
