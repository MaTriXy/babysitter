...
// ---------------------------------------------------------------------------
// Command-family detection (ported from packages/compression/src/engines/command-compressor/index.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Git compressor (ported from packages/compression/src/engines/command-compressor/git.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Ls compressor (ported from packages/compression/src/engines/command-compressor/ls.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Grep compressor (ported from packages/compression/src/engines/command-compressor/grep.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Diff compressor (ported from packages/compression/src/engines/command-compressor/diff.ts)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Filter + read compressor (ported from packages/compression/src/engines/command-compressor/filter.ts + read.ts)
// ---------------------------------------------------------------------------
