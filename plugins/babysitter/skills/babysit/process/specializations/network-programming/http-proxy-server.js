...
export const architectureTask = defineTask('architecture', (args, taskCtx) => ({
  ...
  agent: { name: 'architect', prompt: { role: 'Systems Architect', task: 'Design proxy architecture', context: args, instructions: ['1. Request pipeline', '2. Connection handling', '3. Cache architecture', '4. Filter chain design'] }, outputSchema: { type: 'object', required: ['design', 'artifacts'], properties: { design: { type: 'object' }, artifacts: { type: 'array' } } } },
...
export const connectTunnelTask = defineTask('connect-tunnel', (args, taskCtx) => ({
  ...
  agent: { name: 'tunnel-engineer', prompt: { role: 'Tunnel Engineer', task: 'Implement CONNECT tunnel', context: args, instructions: ['1. CONNECT handling', '2. TLS passthrough', '3. Tunnel management', '4. Timeout handling'] }, outputSchema: { type: 'object', required: ['implementation', 'artifacts'], properties: { implementation: { type: 'object' }, artifacts: { type: 'array' } } } },
...
export const cachingTask = defineTask('caching', (args, taskCtx) => ({
  ...
  agent: { name: 'cache-engineer', prompt: { role: 'Cache Engineer', task: 'Implement caching', context: args, instructions: ['1. Cache storage', '2. Cache-Control headers', '3. Validation/revalidation', '4. Cache eviction'] }, outputSchema: { type: 'object', required: ['implementation', 'artifacts'], properties: { implementation: { type: 'object' }, artifacts: { type: 'array' } } } },
...
export const contentFilteringTask = defineTask('content-filtering', (args, taskCtx) => ({
  ...
  agent: { name: 'filter-engineer', prompt: { role: 'Filter Engineer', task: 'Implement content filtering', context: args, instructions: ['1. URL filtering', '2. Content type filtering', '3. Body inspection', '4. Blocklist/allowlist'] }, outputSchema: { type: 'object', required: ['implementation', 'artifacts'], properties: { implementation: { type: 'object' }, artifacts: { type: 'array' } } } },
...
export const authenticationTask = defineTask('authentication', (args, taskCtx) => ({
  ...
  agent: { name: 'auth-engineer', prompt: { role: 'Authentication Engineer', task: 'Implement authentication', context: args, instructions: ['1. Basic auth', '2. Digest auth', '3. LDAP integration', '4. OAuth support'] }, outputSchema: { type: 'object', required: ['implementation', 'artifacts'], properties: { implementation: { type: 'object' }, artifacts: { type: 'array' } } } },
...
export const loggingTask = defineTask('logging', (args, taskCtx) => ({
  ...
  agent: { name: 'logging-engineer', prompt: { role: 'Logging Engineer', task: 'Implement logging', context: args, instructions: ['1. Access logs', '2. Error logs', '3. Log formats', '4. Log rotation'] }, outputSchema: { type: 'object', required: ['implementation', 'artifacts'], properties: { implementation: { type: 'object' }, artifacts: { type: 'array' } } } },
